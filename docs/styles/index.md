    ...
    <div class="container">
        ...
        <form id="missionForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="spacecraft" name="spacecraft" required>
            </div>
            
            <div class="form-group">
                <label for="destinations">Destinos:</label>
                <textarea id="destinations" name="destinations" required></textarea>
            </div>
            ...
            <button type="submit">Cadastrar Missão</button>
        </form>
